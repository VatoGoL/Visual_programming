        ...
        private async void ClickEventLoad(object sender, RoutedEventArgs e)
        {
            ...
            if (path is not null)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    itemsPlanned.Add(new Card(name, description, pathImage));
                    pathImage = null;
                }
                count = (int)bf.Deserialize(str);
                for (int i = 0; i < count; i++)
                {
                    ...
                    itemsInWork.Add(new Card(name, description, pathImage));
                    pathImage = null;
                }
                count = (int)bf.Deserialize(str);
                for (int i = 0; i < count; i++)
                {
                    ...
                    itemsCompleted.Add(new Card(name, description, pathImage));
                    pathImage = null;
                }
                str.Close();
            }
